    ...
    <div className="min-h-screen bg-[#08090D] text-white flex flex-row font-sans relative overflow-x-hidden selection:bg-[#00F2FE] selection:text-black">
      ...
      <div className="flex-1 flex flex-col min-h-screen relative z-10 overflow-y-auto">
        ...
        <main className="flex-1 max-w-5xl w-full mx-auto px-6 py-8 flex flex-col justify-between">
          ...
          {/* TAB 2: MULTI-PDF UPLOAD & COMPARE */}
          {activeTab === 'upload' && (
            <div className="space-y-6 max-w-3xl mx-auto w-full py-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-slate-400">Upload your draft patent disclosure to compare claim overlaps against reference published patents.</p>
              </div>
              ...
              <button
                type="button"
                onClick={() => alert("Running Deep Vector Claim Comparison...")}
                className="w-full py-3 bg-[#00F2FE] text-[#050609] font-bold text-xs rounded-xl hover:bg-[#38BDF8] transition-all shadow-lg flex items-center justify-center gap-2"
              >
                <Layers className="w-4 h-4" />
                <span>Run Deep Claim Overlap Comparison</span>
              </button>

              <div className="bg-[#12141D] border border-white/10 rounded-2xl p-6 space-y-4">
                <div className="flex justify-between items-center pb-3 border-b border-white/10">
                  <span className="text-xs font-mono uppercase tracking-wider text-slate-400">Claim Overlap Matrix Result</span>
                  <span className="px-3 py-1 bg-amber-500/20 text-amber-300 border border-amber-500/40 rounded-full text-xs font-mono">
                    MEDIUM RISK (84% Overlap)
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-white/5 rounded-xl border border-white/5 text-xs space-y-1">
                    <div className="flex justify-between font-semibold text-white">
                      <span>Independent Claim 1: Neural processing pipeline</span>
                      <span className="text-[#00F2FE] font-mono">89% Overlap</span>
                    </div>
                    <p className="text-slate-400 text-[11px]">Both disclosures specify matrix multiplication hardware units with pipeline registers.</p>
                  </div>

                  <div className="p-3 bg-white/5 rounded-xl border border-white/5 text-xs space-y-1">
                    <div className="flex justify-between font-semibold text-white">
                      <span>Dependent Claim 4: Low-power standby state</span>
                      <span className="text-[#00F2FE] font-mono">76% Overlap</span>
                    </div>
                    <p className="text-slate-400 text-[11px]">Identical power gating circuit sequence found in US10922485B2.</p>
                  </div>
                </div>
