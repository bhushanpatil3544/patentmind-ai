...
function App() {
  ...
  const downloadCitationPatent = (c) => {
    const pnum = c.metadata?.patent_number || 'US-PATENT';
    const pdfUrl = apiUrl(`/api/v1/patents/${pnum}/pdf`);
                              ...
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  const patentKB = {
                                    ...
                                    'US11893452B2': { field: 'Automated Code Generation', filingDate: '2023-01-15', pubDate: '2023-09-10', assignee: 'DeepCode AI Labs', status: 'Granted / Active', abstract: 'Transformer-based real-time source code synthesis paired with AST formal static verification for automated bug detection and code generation.', claims: 'Claim 1: A method for real-time code synthesis comprising tokenizing prompt specifications and verifying AST syntax safety.\nClaim 2: Continuous unit test synthesis.' },
                                    'US11765291B2': { field: 'Cryptography & Cybersecurity', filingDate: '2022-11-10', pubDate: '2023-05-18', assignee: 'CipherSec Technologies', status: 'Granted / Active', abstract: 'Zero-knowledge proof verification for decentralized identity management using non-interactive zk-SNARKs.', claims: 'Claim 1: A zero-knowledge authentication system comprising proof generation circuits and polynomial identity verification.' },
                                    'US11543890B1': { field: 'Autonomous Vehicles & Computer Vision', filingDate: '2022-04-12', pubDate: '2022-11-30', assignee: 'VeloDrive Mobility Inc.', status: 'Granted / Active', abstract: 'Convolutional spatial feature alignment for autonomous vehicle vision systems integrating multi-camera optical feeds with LiDAR point clouds.', claims: 'Claim 1: A computer vision system for autonomous vehicles integrating LiDAR point clouds with camera feature maps.' },
                                    'US11320491B2': { field: 'Edge AI & Neuromorphic Computing', filingDate: '2021-08-19', pubDate: '2022-02-14', assignee: 'NeuroSilicon Corp.', status: 'Granted / Active', abstract: 'Neuromorphic hardware accelerator implementing spiking neural networks with memristive crossbar arrays for micro-watt on-device edge inference.', claims: 'Claim 1: A neuromorphic processor chip comprising asynchronous spiking neurons and analog memristor crossbars.' },
                                    'US11195612B2': { field: 'Bioinformatics & Medical AI', filingDate: '2021-05-04', pubDate: '2021-12-07', assignee: 'GenomiX Analytics', status: 'Granted / Active', abstract: 'Deep learning pipeline for high-throughput genomic read alignment and variant identification.', claims: 'Claim 1: A bioinformatics pipeline using convolutional neural networks for genomic variant identification.' },
                                    'US10984321B1': { field: 'Blockchain & IP Management', filingDate: '2020-09-15', pubDate: '2021-04-20', assignee: 'IPChain Rights Corp.', status: 'Granted / Active', abstract: 'Smart contract protocol for automated royalty distribution and patent licensing management on distributed ledgers.', claims: 'Claim 1: Smart contract protocol for tracking patent utilization and distributing micropayments.' }
                                  };
                                  const kb = patentKB[patNum] || { field: 'General Technology', filingDate: 'N/A', pubDate: 'N/A', assignee: 'PatentMind Partner Labs', status: 'Published', abstract: patExcerpt, claims: 'Claims data being indexed.' };
