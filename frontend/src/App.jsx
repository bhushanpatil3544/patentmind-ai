...
function App() {
  ...
  const downloadCitationPatent = (c) => {
    ...
    const title = c.metadata?.title || 'Patent Specification';
    const section = c.metadata?.section || 'Claims';
    const score = (c.score * 100).toFixed(1);
    const text = c.text || '';

    const content = `=====================================================================
PATENTMIND AI - CITED PATENT DOSSIER
=====================================================================
PATENT NUMBER : ${pnum}
TITLE         : ${title}
SECTION       : ${section}
...
---------------------------------------------------------------------
RETRIEVED SPECIFICATION & CLAIMS EXCERPT
---------------------------------------------------------------------
${text}
...
=====================================================================`;
    ...
    a.href = url;
    a.download = `Patent_${pnum}_Excerpt.txt`;
